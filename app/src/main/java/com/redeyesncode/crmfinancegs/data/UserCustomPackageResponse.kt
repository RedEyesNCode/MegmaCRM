...
data class UserCustomPackageResponse( @SerializedName("status"  ) var status  : Boolean? = null,
    ...
    data class Package (
        ...
        @SerializedName("package"      ) var packageString     : String?                = null,
        @SerializedName("hgfds"        ) var hgfds       : Int?                   = null,
        @SerializedName("package_data" ) var packagesData : ArrayList<PackageData> = arrayListOf()
